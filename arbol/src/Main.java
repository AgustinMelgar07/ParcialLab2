...
switch (opcion) {
    case 1:
        elemento = JOptionPane.showInputDialog(null, "ingrese numero del nodo", "agregar nodo", JOptionPane.QUESTION_MESSAGE);
    ...
    case 3:
        if (!arbolito.estavacio()) {
            arbolito.levelOrderTraversal(arbolito.raiz);
        } else {
    ...
    case 5:
        if (!arbolito.estavacio()) {
            elemento = JOptionPane.showInputDialog(null, "ingrese el nodo que quiera buscar",
    ...
    case 6:
        ...
        if (!arbolito.estavacio()) {
            elemento = String.valueOf(Integer.parseInt(JOptionPane.showInputDialog(null, "ingrese el nodo que quiera buscar",
                    "buscar nodo", JOptionPane.QUESTION_MESSAGE)));
            arbolito.eliminarRecursivo(arbolito.raiz,elemento);
        }
        break;
    case 7:
